 ...
 */
@PWA(name = "My First Vaadin App", shortName = "My First Vaadin App", enableInstallPrompt = false)
@Theme(themeFolder = "myfirstvaadinapp")
@PageTitle("Main")
@Route(value = "")
public class MainLayout extends AppLayout {
    ...
    private Component createDrawerContent(Tabs menu) {
        ...
        logoLayout.add(new Image("images/logo.png", "My First Vaadin App logo"));
        logoLayout.add(new H1("My First Vaadin App"));
    ...
    private List<Tab> createMenuItems() {
        MenuItemInfo[] menuItems = new MenuItemInfo[]{ //
                new MenuItemInfo("My Products", "la la-cubes", MyProductsView.class), //

                new MenuItemInfo("New Product", "la la-cube", CreateProductForm.class), //

                new MenuItemInfo("DashBoard", "la la-pie-chart", DashBoardView.class), //
